...
@pytest.fixture
def list_of_dictionaries() -> list[dict]:
    return [
...
@pytest.fixture
def list_of_dictionaries_sorted_by_default_state() -> list[dict]:
    return [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
    ]
...
@pytest.fixture
def list_of_dictionaries_sorted_by_canseled_state() -> list[dict]:
    return [
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
    ]
...
@pytest.fixture
def list_of_dictionaries_with_same_date() -> list[dict]:
    return [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
...
@pytest.fixture
def list_of_dictionaries_sorted_by_date() -> list[dict]:
    return [
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
...
@pytest.fixture
def list_of_dictionaries_sorted_by_date_from_early() -> list[dict]:
    return [
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"},
...
def csv_transactions():
    return [{'id': '1245327', 'state': 'PENDING', 'date': '2021-03-09T00:56:48Z', 'amount': '24252',
          'currency_name': 'Somoni', 'currency_code': 'TJS', 'from': 'Discover 3233958335206913',
          'to': 'Visa 6269545625045856', 'description': 'Перевод с карты на карту'},
         {'id': '134341', 'state': 'CANCELED', 'date': '2022-03-03T08:41:08Z', 'amount': '13642',
