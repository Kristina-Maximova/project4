...
from src.main import get_data_by_choice, sort_by_choice_date, sort_by_choice_state, sort_by_choice_currency, \
    sort_by_choice_by_description, create_report, main
...
@pytest.mark.parametrize("data, expected", [
    ([{'id': '4653425', 'state': 'EXECUTED', 'date': '2020-03-10T07:48:21Z', 'amount': '22131',
       'currency_name': 'Ruble', 'currency_code': 'RUB', 'from': '', 'to': 'Счет 58936710508356884628',
    ...
    ([{'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689',
     ...
     [['12.09.2018', 'Перевод организации', 'Visa Platinum 1246 37** **** 3588 -> ', 'Счет **1657', 'Cумма: 67314.70',
       '', 'руб.']]),
    ([{'id': 4739714.0, 'state': 'CANCELED', 'date': '2021-03-16T09:50:38Z', 'amount': 29700.0, 'currency_name': 'Baht',
       'currency_code': 'THB', 'from': 'Discover 5448680041474638', 'to': 'Счет 81509213611289630443',
       'description': 'Перевод организации'}],
     [['16.03.2021', 'Перевод организации', 'Discover 5448 68** **** 4638 -> ', 'Счет **0443', 'Cумма: 29700.0', 'Baht',
       '']])])
